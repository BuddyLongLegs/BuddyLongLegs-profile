  ...
  useEffect(()=>{
    router.events.on("routeChangeStart", (url)=>{
      if(url !== router.pathname){
        setIsHome((h)=>{return true;})
        router.pathname = url;
        document.getElementById("title").classList.remove(styles.title_final1);
        document.getElementById("title").classList.remove(styles.title_final);
        document.getElementById("connbar").classList.remove(styles.connbar_show)
        document.getElementById("conncir").classList.remove(styles.conncir_show)
      }
    })
	}, [router, isHome])
  return (
